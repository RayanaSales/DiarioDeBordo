    ...
    <body>
        <div class="card card-5" >
            ...
            <div style="margin-top: 0px; width: 100%; height: 15%; background-color: rgb(63,81,181); color: white;">
                <span style="margin: 193px; line-height: 72px; font-size: 17px; font-weight: bold;">Editar</span>
            </div>           

            <form action="/DiarioDeBordo_Web2/EditarDadosCapituloServlet" id="formulario" method="post">
                ...
                <div class="formulario">
                    ...
                    <input class="btn" type="submit" value="Editar" style="background-color: rgb(63,81,181);">
